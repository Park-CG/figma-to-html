...
import { Clock, MapPin, Phone, Star, Sparkles } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-8">
      ...
      <div className="relative text-center mb-12">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-slate-800 text-white rounded-2xl mb-6 shadow-lg shadow-slate-800/25 backdrop-blur-sm">
          <Clock className="w-6 h-6" />
          <span className="font-semibold tracking-wide">운영시간 안내</span>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -top-2 -right-8 text-yellow-400">
      ...
      <div className="grid gap-6 mb-12">
        {scheduleData.map((item, index) => (
          <Card key={item.day} className="group relative overflow-hidden border-0 bg-white/70 backdrop-blur-xl shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-gray-300/60 transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-white/90 via-white/95 to-gray-50/90 group-hover:from-white group-hover:via-white group-hover:to-white transition-all duration-500"></div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
                  </div>
                  
                  {/* Time Info */}
                  <div className="flex flex-col space-y-2">
                    <span className="text-lg text-gray-500 font-light tracking-wide">{item.dayKor}</span>
                ...
                {/* Level Badge */}
                <Badge className={`${item.levelColor} backdrop-blur-sm px-6 py-3 font-semibold text-lg w-20 justify-center shadow-lg hover:scale-105 transition-transform duration-300`}>
                  {item.level}
                </Badge>
              </div>
            </CardContent>
      ...
      {/* Info Section */}
      <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-slate-50/90 via-blue-50/80 to-indigo-50/90 backdrop-blur-xl shadow-2xl shadow-blue-200/30">
        ...
        <CardContent className="relative p-10">
          <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start gap-4 p-3 rounded-xl bg-white/50 backdrop-blur-sm hover:bg-white/70 transition-colors duration-300">
                    <div className="mt-1 w-2 h-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex-shrink-0"></div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/50 backdrop-blur-sm hover:bg-white/70 transition-colors duration-300 group">
      ...
      {/* Premium Footer */}
      <div className="text-center mt-12 p-8 bg-gradient-to-r from-gray-900 via-slate-800 to-gray-900 rounded-3xl shadow-2xl shadow-gray-800/20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent"></div>
        <div className="relative flex items-center justify-center gap-3 mb-3">
          <p className="text-white/90 font-medium text-lg">
            정확한 시간 확인을 위해 사전 연락 후 방문해주시기 바랍니다
          </p>
        </div>
