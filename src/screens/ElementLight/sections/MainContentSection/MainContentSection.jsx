      ...
      <div className="flex flex-col items-center p-[25px] relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="flex flex-col items-start gap-2.5 pt-[19px] pb-[16.8px] px-0 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col items-center pt-[15.6px] pb-[0.69px] px-0 relative self-stretch w-full flex-[0_0_auto] opacity-80">
            <p className="w-fit mt-[-1.00px] [font-family:'Noto_Sans_KR',Helvetica] font-normal text-white text-sm text-center leading-[16.8px] relative tracking-[0]">
            ...
            <p className="w-fit mt-[-0.51px] [font-family:'Noto_Sans_KR',Helvetica] font-normal text-white text-sm text-center leading-[16.8px] relative tracking-[0]">
          ...
          <div className="flex flex-col items-center pt-[40.39px] pb-0 px-0 relative self-stretch w-full flex-[0_0_auto]">
            <button
              className="inline-flex items-start justify-center pt-2.5 pb-[11.14px] px-[26px] relative flex-[0_0_auto] bg-white border border-solid border-black hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
              type="button"
